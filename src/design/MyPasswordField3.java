...
public class MyPasswordField3 extends JPasswordField {
    ...
    public MyPasswordField3() {

        
        setOpaque(false);

        // Đặt màu nền với độ mờ 50%
        Color a = new Color(80, 80, 80, 80);
        setBackground(a);
        ...
        eye = new ImageIcon(getClass().getResource("/design/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/design/eye_hide.png")).getImage();
